...
public class SaslAuthenticatedTest {
    ...
    private String _ip = "192.168.133.62";
    ...
    private String createJaasFile() throws IOException {
        ...
        FileOutputStream jaasOutputStream = new FileOutputStream(jaasFile);
    ...
    private void bootstrap() throws IOException {
        ...
        _zkServer = TestUtil.startZkServer(_temporaryFolder, _ip,_port);
    ...
    public void testUnauthenticatedClient() throws IOException {
        ...
        try {
            ...
            unauthed = new ZkClient(_ip +":" + _port, 6000);
