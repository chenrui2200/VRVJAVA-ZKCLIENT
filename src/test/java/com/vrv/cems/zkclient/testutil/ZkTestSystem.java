 ...
 */
package com.vrv.cems.zkclient.testutil;
...
public class ZkTestSystem extends ExternalResource {
    ...
    private static String IP = "192.168.133.63";
    ...
    private ZkTestSystem() {
        ...
        _zkServer = new ZkServer(dataDir, logDir, mock(IDefaultNameSpace.class),IP, PORT);
        _zkServer.start();
